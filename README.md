...
It also checks the consistency of the Object ID tags in DOR/DPD-DPT and DVP keys and generate the header file.
...
XMLtoDDOP = Creates ddop.c and ddop.h files from ddop.xml source file with array name DDOP_E2IS

XMLtoDDOP -f DDOP_MINE = Creates ddop.c and ddop.h files from ddop.xml source file with array name DDOP_MINE

XMLtoDDOP ddop_tcbas.xml ddop_tcbas.c = Creates ddop_tcbas.c and ddop_tcbas.h files from ddop_tcbas.xml source file
